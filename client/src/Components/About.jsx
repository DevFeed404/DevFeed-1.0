...
export default function About() {
  return (
    <>
      ...
      <div className='h-fit flex dark:bg-[#0D2F3F] flex-row mlg:flex-col w-screen background mh-[2vh] pb-[13vh] pt-[6vh] ' id='about'>
        ...
        <div className='flex flex-col items-center xxlg:w-[60%] lg:w-[65%] w-[63%] mlg:w-[100%] pr-[4vw] about-con'>
          <h1 className=' about-title mt-[9vh] xlg:mt-[2vh]  sm:text-4xl xsm:text-3xl text-5xl font-mono items-center font-bold text-black dark:text-gray-50'>Nice to meet you</h1>
          {/* Using HTML Entities for the apostrophe */}
          <p className='about-p text-xl  xsm:text-sms sm:text-lg mt-[3vh] ml-[4vw] mr-2 dark:text-gray-100 text-[#0D2F3F]  font-medium font-sans'>With <span className='text-[#1c145f] comme'>DevFeed</span>, you&#39;ll never miss out on an opportunity to not only expand your skills but also connect with other tech professionals in your community. Our newsletter is your personal roadmap to navigating the tech scene, providing you with exclusive <span >updates on the latest events, speakers, and topics that matter most to you.</span></p>
          <ul class="list-disc about-pts ml-[1.2vw]  pt-3 text-xl sm:text-lg xsm:text-sms dark:text-gray-100 text-[#0D2F3F] font-medium ">
